...
def Video(input_path, output_path):
    ...
    while True:
        ...
        img1 = cv2.resize(img, (0, 0), fx = 0.6, fy = 0.6)
        dark = DarkChannel(I, 15)
        A = AtmLight(I, dark)
        te = TransmissionEstimate(I, A, 15)
        t = TransmissionRefine(img, te)
        J = Recover(I, t, A, 0.1)
        J = cv2.resize(J, (0, 0), fx = 0.6, fy = 0.6)
        cv2.imshow('Output', J)
...
if __name__ == '__main__':
    Video(r"C:\Users\Lohesh\Downloads\Notes\smh_Hack\dark_channel\Input1.mp4", r"C:\Users\Lohesh\Downloads\Notes\smh_Hack\dark_channel\outputfirewa.me.mp4")
